                ...
                <div class="py-2 inline-block min-w-full sm:px-6 lg:px-8">
                    <div class="overflow-hidden">
                        <div class="flex justify-end mb-4">
                            <a href="{{ route('users.create') }}" class="inline-block px-6 py-2.5 mb-1 bg-blue-600 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out">Create</a>
                        </div>
                        ...
                        <table class="min-w-full">
                            <thead class="bg-white border-b">
                                <tr>
                                    ...
                                    <th scope="col" class="w-1 text-sm font-medium text-gray-900 px-6 py-4 text-left whitespace-nowrap">Email</th>
                                    <th scope="col" class="w-1 text-sm font-medium text-gray-900 px-6 py-4 text-left whitespace-nowrap">Role</th>
                                    <th></th>
                                </tr>
                            </thead>
                            <tbody>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="5" class="text-center text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">No record found</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
